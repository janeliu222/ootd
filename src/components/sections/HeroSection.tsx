...
const HeroSection = () => {
  return <section className="relative py-12 bg-white">
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        duration: 0.5
          ...
          <p className="mx-auto max-w-2xl text-sm sm:text-base text-muted-foreground">Exploring everyday: a private social network where authenticity meets exclusivity.</p>
        </motion.div>
      </div>
    </section>;
};
